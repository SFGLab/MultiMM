...
| ------------------ | ---- | ---------- | --------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| EV_FORCE_TYPE      | str  | powerlaw   | powerlaw, gaussian_core                    | Controls excluded volume repulsion functional form (from hard-scale repulsion to soft-core melt-like behavior).                                                        |
